...
#delimit cr
* Check for variation in proposed vector of variables
sum $factors
...
#delimit ;
global factors "electricity openFire dwellingSize metalRoof 
			 cmtfloor protWater waterTime latrineCovered";
#delimit cr
sum $factors
factor $factors if urban == 1, pcf 
...
save "$pathout/hhinfra_2009.dta", replace
log2html "$pathlog/06_hhchar_2009", replace
capture log close
