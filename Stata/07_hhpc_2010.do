...
clear
capture log close
log using "$pathlog/07_hhpc_2010", replace
set more off

* Load the assets module
use "$wave2/GSEC14.dta"
...
* Cap owernship number to 20 (may even be too high; 333 casettes)
recode h14q4 (21/333 = 20)
...
*end
save "$pathout/hhpc_2010.dta", replace
log2html "$pathlog/07_hhpc_2010", replace
capture log close
